...
public class BoundingBoxFeatureCountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_query_bbox_feature_count);
        ...
        final View viewContainer = findViewById(R.id.query_bbox_feature_count_map_container);
