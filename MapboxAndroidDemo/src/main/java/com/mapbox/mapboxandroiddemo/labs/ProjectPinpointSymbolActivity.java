...
public class ProjectPinpointSymbolActivity extends AppCompatActivity implements OnMapReadyCallback {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_project_pinpoint_symbol);
  ...
  private static class LoadPoiDataTask extends AsyncTask<Void, Void, FeatureCollection> {
    ...
    LoadPoiDataTask(ProjectPinpointSymbolActivity activity) {
  ...
  private static class GenerateViewIconTask extends AsyncTask<FeatureCollection, Void, HashMap<String, Bitmap>> {
    ...
    GenerateViewIconTask(ProjectPinpointSymbolActivity activity) {
      this(activity, false);
    }
   ...
   */
  static class LocationRecyclerViewAdapter extends RecyclerView.Adapter<ProjectPinpointSymbolActivity.LocationRecyclerViewAdapter.MyViewHolder> {

    private List<Feature> featureCollection;
    private ProjectPinpointSymbolActivity activity;

    LocationRecyclerViewAdapter(ProjectPinpointSymbolActivity activity, FeatureCollection featureCollection) {
