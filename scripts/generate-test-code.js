...
const appBasePath = 'MapboxAndroidDemo/src/main/java/com/mapbox/mapboxandroiddemo/examples';
const testBasePath = 'MapboxAndroidDemo/src/androidTest/java/com/mapbox/mapboxsdk/testapp/gen';
const subPackages = fs.readdirSync(appBasePath);
const ejsConversionTask = ejs.compile(fs.readFileSync('MapboxAndroidDemo/src/androidTest/java/com/mapbox/mapboxsdk/testapp/activity.junit.ejs', 'utf8'), {strict: true});
